...
```{r joint-group-vowel-accuracy, fig.width=10, fig.height=6.6}
...
```{r joint-group-vowel-acc-known, fig.width=10, fig.height=6.6}
...
```{r joint-group-vowel-acc-inferred, fig.width=10, fig.height=6.6}
