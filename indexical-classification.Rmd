...
```{r acc-plots, fig.width=4.3, fig.height=4.3}
...
```{r acc-by-group-summary, results='asis'}
...
```{r acc-by-group-plots, fig.width=8, fig.height=4.3}
...
```{r dialect-confusion-mats, fig.width=8, fig.height=4.3}
...
```{r talker-dialect-classification, fig.width=11, fig.height=3.1}
