...
```{r marginalize-and-aggregate, cache=TRUE}
...
#'
#' @param group_category_posteriors category posterior probabilities conditional on
#'   group, in the form of a data frame with at least columns category_model,
#'   group_model, and posterior (e.g., output of compute_category_post_given_group)
...
#' @return a data frame with the joint posterior of category category and group, in
...
```{r train-vot-models, eval=FALSE}


t <- train_models_indexical_with_holdout(vot_by_place$data[[1]],
                                    groups = 'Sex',
                                    category = 'voicing',
                                    formants = 'vot')
