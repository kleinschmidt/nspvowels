...
The model used is a simplistic, "flat" model that models all tokens of a vowel in a group as coming from a single Gaussian distribution. In reality, the tokens of a single vowel are produced by a _mixture_ of talker-specific distributions. It's possible that our results here are biased as a result.
